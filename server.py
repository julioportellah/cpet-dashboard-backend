...
@app.route("/api/get_cardiac_interpretation_by_session_id/<session_id>",
            methods=["GET"])
def get_cardiac_cpet_intepretation_by_id(session_id):
    ...
    """
    try:
        type_interpretation = 'cardiac'
        shap_custom_result = cps.get_cardiac_cpet_intepretation_by_id(session_id, type_interpretation)
        #res, code = hr.get_record_by_patient_id(patient_id)
        return json.dumps(shap_custom_result[0]), 200
...
@app.route("/api/get_pulmonary_interpretation_by_session_id/<session_id>",
            methods=["GET"])
def get_pulmonary_cpet_intepretation_by_id(session_id):
    """API that returns a base64 of the force plot and custom shap summary
...
@app.route("/api/get_other_interpretation_by_session_id/<session_id>",
            methods=["GET"])
def get_other_cpet_intepretation_by_id(session_id):
    """API that returns a base64 of the force plot and custom shap summary
